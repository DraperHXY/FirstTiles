...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="/FirstTiles/img/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="/FirstTiles/img/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="/FirstTiles/img/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="/FirstTiles/img/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="/FirstTiles/img/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="/FirstTiles/img/4525424.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="/FirstTiles/img/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="/FirstTiles/img/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="/FirstTiles/img/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="/FirstTiles/img/453254312.png">12400<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach items="${excellentStudentList}" var="student">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="/FirstTiles/img/242424.png">
                        <span>${student.position}${student.name}</span>
                        <p class="text-left">${student.description}</p>
                    </div>
                </li>
            </c:forEach>
        </ul>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="/FirstTiles/img/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="/FirstTiles/img/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="/FirstTiles/img/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="/FirstTiles/img/1471.png"></a>
                </li>
                <li>
                    <a href=""> <img src="/FirstTiles/img/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
